    ...
    <header className={`header`}>
      <div className="headerPosition">
        ...
        <span className="headerLinkContainer">
          ...
          <Link to={"/service"} className="headerLink">
            Услуги
          </Link>
          <Link to={"/ticket/new"} className="headerLink">
            Оставить заявку
          </Link>
        </span>
        <img
          src={burger}
          alt=""
          className="burgerMenu__icon burgerHide"
          onClick={() => modalStatement.switchState()}
        />
        <BurgerModal
          showed={modalStatement.showing}
          closeModal={modalStatement.close}
        />
      </div>
    </header>
  );
