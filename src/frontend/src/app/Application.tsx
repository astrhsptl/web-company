...
export default function Application() {
    ...
    useEffect(() => {
        if (!complited) {
            console.log(
                `Привет, мы команда Потребления контента и рекомендаций — создаём раздел, в котором ты сейчас находишься. Хочешь присоединиться к нам? Заполни форму и присоединяйся к нам: https://https://bookshelf.labofdev.ru/job`
            );
            setComplited(true);
        }
    });
